(function () {
  ...
  var T = {
    de: {
      ...
      'card.education.text':  'Seit 2008 realisiert das BSOF Education-Projekte für Kinder und Jugendliche – darunter die Reihe „Spannungsfelder". Der Förderverein sichert die Finanzierung durch Einwerbung von Fördergeldern.',
      'card.kaleidoskop.title': 'Kaleidoskop',
      'card.kaleidoskop.text':  'Ein neues Education-Projekt mit Schülerinnen und Schülern aus Frankfurt (Oder) und Słubice: Musik von Bach und Piazzolla erzählt von den Farben im menschlichen Miteinander.',
      ...
      'slider.prev': 'Zurück',
      'slider.next': 'Weiter',
      'mini.label':   'Musik in der Stadt',
      'mini.orte.h2': 'Orte',
      'mini.ort1': 'Seniorenheime',
      'mini.ort2': 'Kindergärten',
      'mini.ort3': 'Hospiz',
      'lese.label':     'Literatur & Musik',
      'lese.format.h2': 'Das Format',
      'auf.label':     'Kompositionsaufträge',
      'auf.urauff.h2': 'Uraufführungen',
      'edu.label':  'Kulturelle Bildung',
      'edu.spannungsfelder.tag':  'Teilprojekt',
      'edu.spannungsfelder.h2':   'Spannungsfelder',
      'edu.spannungsfelder.link': 'Mehr zu Spannungsfelder erfahren',
      'back.education':      '← Education-Projekte',
      'back.education.link': 'Zurück zu Education-Projekte',
      ...
      'kal.label':      'Education-Projekt 2026/27',
      'kal.subtitle':   '»Wie gehen wir miteinander um?«',
      'kal.termine.h2':     'Termine',
      'kal.mitwirkende.h2': 'Mitwirkende',
      'kal.musik.h2':   'Die Themen. Die Musik.',
      'kal.thema1': 'Klage / Trauer / Verzweiflung',
      'kal.thema2': 'Hass / Mobbing / Hetze',
      'kal.thema3': 'Schmerz / Leid',
      'kal.thema4': 'Gleichgültigkeit',
      'kal.thema5': 'Mitgefühl / Liebe',
    },
    en: {
      'nav.ueber':    'About us',
      ...
      'card.education.text':  'Since 2008, BSOF has been realising education projects for children and young people – including the „Spannungsfelder" series. The Förderverein secures the funding by raising grants.',
      'card.kaleidoskop.title': 'Kaleidoskop',
      'card.kaleidoskop.text':  'A new education project with pupils from Frankfurt (Oder) and Słubice: music by Bach and Piazzolla tells of the colours in how people treat one another.',
      ...
      'slider.prev': 'Back',
      'slider.next': 'Next',
      'mini.label':   'Music in the city',
      'mini.orte.h2': 'Venues',
      'mini.ort1': 'Care homes',
      'mini.ort2': 'Kindergartens',
      'mini.ort3': 'Hospice',
      'lese.label':     'Literature & Music',
      'lese.format.h2': 'The format',
      'auf.label':     'Commissioned compositions',
      'auf.urauff.h2': 'World premieres',
      'edu.label':  'Cultural education',
      'edu.spannungsfelder.tag':  'Sub-project',
      'edu.spannungsfelder.h2':   'Spannungsfelder',
      'edu.spannungsfelder.link': 'Find out more about Spannungsfelder',
      'back.education':      '← Education Projects',
      'back.education.link': 'Back to Education Projects',
      ...
      'kal.label':      'Education project 2026/27',
      'kal.subtitle':   '»How do we treat one another?«',
      'kal.termine.h2':     'Dates',
      'kal.mitwirkende.h2': 'Participants',
      'kal.musik.h2':   'The themes. The music.',
      'kal.thema1': 'Grief / Sorrow / Despair',
      'kal.thema2': 'Hatred / Bullying / Incitement',
      'kal.thema3': 'Pain / Suffering',
      'kal.thema4': 'Indifference',
      'kal.thema5': 'Compassion / Love',
    }
  };
